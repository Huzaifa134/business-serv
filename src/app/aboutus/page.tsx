...
export default async function AboutUs() {
       ...
       <div className="flex flex-col mx-20 px-5">
        ...
        {/* <ul>
          <li className="mx-20 "> */}
            ...
            <div className="font-bold text-center md:text-xl max-[900px]:text-[20px] max-[700px] my-18"> {data?.title} </div>
            <div>
 ...
 non refundable consultancy fee of 50 USD , once you have signed contract with us we will pay it back to you.  
          ...
          <li className="mx-20 my-10">
            ...
            <p>
Pleas              e note that our service plans are customized based on the
