        ...
        <ul>
          <li className="mx-20 ">
            ...
            <p className="my-3">
              ...
              page on our website to get an overview of the comprehensive
              services we offer.
            </p>
          </li>
          ...
          <li className="mx-20 my-10">
            ...
            <p>
              If you wish to schedule a meeting for a more in-depth discussion
              or consultation, you can do so by scheduling a meeting in our
          ...
          <li className="mx-20 my-10">
            ...
            <p>
              Please note that scheduling a meeting after deciding a specific day for your meeting you have to pay a 30 minute 
 non refundable consultancy fee of 50 USD , once you have signed contract with us we will pay it back to you.  
          ...
          <li className="mx-20 my-10">
            ...
            <p>
              ...
              your email address and phone number, to receive timely and
              accurate responses from our team.
            </p>
          </li>
          <li className="mx-20 my-10">
            <h2 className="font-bold md:text-xl max-[700px]:text-[20px] max-[700px]">
            ...
            <p>
              Please note that our service plans are customized based on the
              size and type of business consultancy services you require. There
              are no fixed rates, and we tailor our plans to meet the unique
          ...
          <li className="mx-20 my-10">
            ...
            <p>
              ...
              continuous support and guidance. Our team is here to assist you
          ...
          <li className="mx-20 my-10">
            ...
            <p>
              You are using our services for a one-time consultation or an
              ongoing partnership, we aim to provide you with a seamless and
              efficient experience tailored to the specific needs of your
              business.
            </p>
          </li>
      ...
      <ul>
        ...
        <li className="mx-20 my-10">
          ...
          <p>
            ...
            us page form. Please note that scheduling a meeting requires a
            consultation fee of $75 USD.
          </p>
        </li>
        <li className="mx-20 my-10">
          <h2 className="font-bold md:text-xl max-[700px]:text-[20px] max-[700px]">
          ...
          <p>
            After selecting a specific date for your meeting, you will be
            prompted to pay a $75 USD meeting consultancy fee. This fee ensures
            a dedicated time slot for your consultation.
          </p>
        </li>
        <li className="mx-20 my-10">
          <h2 className="font-bold md:text-xl max-[700px]:text-[20px] max-[700px]">
