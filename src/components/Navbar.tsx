        ...
        <nav>
          <ul className="text-lg font-medium hidden md:flex gap-x-4 text-gray-600">
           ...
           <li className="" >
              ...
              key={name}
              href={link}
            className={` ${pathname === link ? 'underline text-teal-50': 'bg-orange '}`}> {name} </Link>
            </li>
                )} 
            {/* <li className="">
          ...
          <div className="flex md:hidden">
           ...
           <li className="py-2" >
              ...
              key={name}
              href={link}
            className={` ${pathname === link ? 'underline text-black  active:bg-cyan-100': 'bg-orange '} hover:bg-slate-600`}> {name} </Link>
            </li>
                )} 
                    {/* <li className="py-3 ">
                      <Link href={"/"}>Home </Link>
